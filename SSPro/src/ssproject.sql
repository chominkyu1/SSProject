...
(
    ...
    SPACEPOST_IMAGE    VARCHAR2(300) NOT NULL,
...
insert into SPACEPOST values ('SP'||lpad (seq_SP.nextval,3,0), 'SM002','마포구','골든핸즈라운지', '050-7459-9549','서울특별시 마포구 망원동 439-44 1층 골든핸즈라운지','100*200','../src/image',to_date('18/02/01','yy/MM/DD'),
to_date('18/09/01','yy/MM/DD'),'카페', '소규모 워크샵, 원데이 클라스와 같은 소규모형태의 모임과 잘 어울리는 공간입니다. 골든핸즈라운지의 따뜻하고 아늑한 분위기가 모임을 더욱 친근하고 편안하게 진행되도록 할 것입니다. * 
...
'100*100','../src/image',to_date('18/02/01','yy/MM/DD'),to_date('18/09/01','yy/MM/DD'),
...
'100*100','../src/image',to_date('18/02/01','yy/MM/DD'),to_date('18/09/01','yy/MM/DD'),'레스토랑',
...
'../src/image',to_date('18/02/01','yy/MM/DD'),to_date('18/09/01','yy/MM/DD'),'카페','2015년 성수동에 오픈한 사진창고는 공장을 개조해 만든 인더스트리얼 느낌의 갤러리카페로 연중 사진전시가 진행되며 식사와 주류와 음료가 가능한 복합문화공간입니다. 수용 규모는 1층 홀은 45평 규모로 70~100명, 

				...
				<div class="row">
					<div class="col-md-6 bor">
						<h1 class="bodytxt2 hanguel">
							<%=request.getParameter("smember_name")%>님 안녕하세요! 회원님의 <br>공간
							등록을 도와드리겠습니다.
						</h1>
						...
						<div class="col-xs-9">
							...
							<div class="form-group">
								<label class="form-label" for="subject">대여 시작일</label> <input
									...
									name="startdate" placeholder="대여 시작일" tabindex="3" required>
							</div>
							<div class="form-group">
								<label class="form-label" for="subject">대여 마감일</label> <input
									type="date" class="form-control" id="finishdate"
									name="finishdate" placeholder="대여 마감일" tabindex="3" required>
							</div>
							...
							<div class="form-group">
								<label class="form-label" for="subject">해시태그(','로
									구분해주세요)</label>
								<textarea class="form-control" rows="5" id="hashtag"
					...
					<div class="col-md-6 collapse" id="collapseExample">
						...
						<div class="row"></div>
						<br>
						<button class="button" type="button" onclick="date()">
		...
		<div class="modal fade" id="exampleModal2" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">대여 시작일은 대여 종료일 보다 더 빨라야 합니다!</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal">되돌아가기</button>
					</div>
				</div>

...
<body background="img/bg/login_bg.jpg">
	...
	<br><br>
		...
		<div class="col-md-2">
		<button type="button" class="btn btn-primary btn-block">아티스트 회원</button>
		</div>
		<div class="col-md-5"></div>
		</div>
		...
		<div class="col-md-5"></div>
		<div class="col-md-2">
		<button type="button" class="btn btn-block">공간대여 회원</button>
		</div>
		<div class="col-md-5"></div>
		</div>

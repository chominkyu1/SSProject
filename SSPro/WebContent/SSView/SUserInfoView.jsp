...
<input type="hidden" name="smember_id" value="${memberspacevo.smember_id }">
  ...
  <div class="form-group"><div class="col-md-2"></div>
    ...
    <div class="col-md-4">
      <input type="text" class="form-control"  placeholder="핸드폰번호('-'제외)" name="smember_phone" value="${memberspacevo.smember_phone }" onKeyPress="return numkeyCheck(event)" required>
    </div>
  </div>

   ...
   <form name="frmName1" method="post"> <!-- 사용자 입력 받는 폼  -->
     <table width="50%" border="1" align="center" cellpadding="1" cellspacing="1">
       ...
       <tr>
         ...
         <textarea name="abstract" cols="40" onkeyup="inputValue(this.form,abstract,frmName2,2)"><%=getParam(request,"abstract")%></textarea></td>
       </tr>
       <tr>
...
<form name="frmName2" method="post" enctype="multipart/form-data" action="upload_cos_ok.jsp"><!--파일 업로드를 위한 파일정보를 입력받는다-->
